...
public final class ChatControl extends Composite {
        ...
        public void connected(final JID jid) {
            SWTUtils.runSafeSWTAsync(null, new Runnable() {
                ...
                public void run() {
                    ...
                    addChatLine(
                        new ChatElement(jid, new Date(), ChatElementType.JOIN));
    ...
    public ChatControl(final ChatRoomsComposite chatRooms, final IChat chat,
        ...
        // added this
        writer = new PrintWriter("chat-log.txt", "UTF-8");
        ...
        addListener(SWT.Resize, new Listener() {
            ...
            public void handleEvent(Event event) {
                ...
                int lineHeight = (int) Math.round(
                    chatInput.getFont().getFontData()[0].getHeight() * 1.4);
                ...
                sashForm.setWeights(
                    new int[] { newChatDisplayHeight, chatInputHeight });
            }
        });
     ...
     */
    public void addChatControlListener(
    ...
    public void notifyCharacterEntered(Character character) {
        for (IChatControlListener chatControlListener : chatControlListeners) {
            chatControlListener
                .characterEntered(new CharacterEnteredEvent(this, character));
        }
    }
    ...
    public void notifyMessageEntered(String message) {
        for (IChatControlListener chatControlListener : chatControlListeners) {
            chatControlListener
                .messageEntered(new MessageEnteredEvent(this, message));
        }
    }
    ...
    private void toggleChatBoldFontStyle() {
        ...
        if (fds.length > 0) {
            chatRooms.getChatTab(chat)
                .setFont(new Font(getDisplay(), fds[0].getName(),
